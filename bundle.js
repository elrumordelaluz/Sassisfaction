...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_App2.default, { jsonURL: 'sassisfaction.json' }), document.querySelector('#items'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isomorphicFetch = __webpack_require__(161);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.handleTagEvent = _this.handleTagEvent.bind(_this);
	    _this.handleFocus = _this.handleFocus.bind(_this);
	    _this.handleGA = _this.handleGA.bind(_this);
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      (0, _isomorphicFetch2.default)(this.props.jsonURL).then(function (response) {
	        return response.json().then(function (json) {
	          var libs = json.map(function (item) {
	            return {
	              name: item.name,
	              url: item.url,
	              tags: item.tags,
	    ...
	    key: 'handleTagEvent',
	    value: function handleTagEvent(e) {
	    ...
	    key: 'handleGA',
	    value: function handleGA(e) {
	      var val = this._textInput.value;
	    ...
	    value: function render() {
	      ...
	      if (searchString.length > 0 && !re.test(searchString)) {
	        ...
	        (function () {
	          ...
	          var libsByTag = libraries.filter(function (l) {
	            return str.indexOf(':') !== -1 ? l.tags.indexOf(before) !== -1 : l.tags.indexOf(str) !== -1;
	          });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'main-search top', ref: function ref(c) {
	              return _this3._mainSearch = c;
	            } },
	          _react2.default.createElement(
	            'label',
	            null,
	            _react2.default.createElement('svg', { className: 'search-icon', dangerouslySetInnerHTML: { __html: "<use xlink:href='assets/symbols.svg#icon-search'/>" } }),
	            _react2.default.createElement('input', { type: 'text', ref: function ref(c) {
	                return _this3._textInput = c;
	              }, value: this.state.searchString, onFocus: this.handleFocus, onChange: this.handleChange, onKeyUp: this.handleEsc, onBlur: this.handleGA, placeholder: 'Search...' }),
	            _react2.default.createElement('svg', { className: 'close-icon', ref: function ref(c) {
	                return _this3._closeBtn = c;
	              }, onClick: this.handleClear, dangerouslySetInnerHTML: { __html: "<use xlink:href='assets/symbols.svg#icon-close'/>" } })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          libraries.map(function (lib) {
	            return _react2.default.createElement(_Item2.default, { title: lib.name, desc: lib.desc, link: lib.url, tags: lib.tags, key: h.toHash(lib.name), image: lib.image, onClickTag: _this3.handleTagEvent });
	          }).reverse()
	        )
	      );
	    }
...
/***/ function(module, exports) {
	...
	var toHash = exports.toHash = function toHash(str) {
	  var hash = 0,
	      i = void 0,
	      chr = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = function Item(props) {
	  var altLogo = _react2.default.createElement('svg', { className: 'alt-logo',
	    dangerouslySetInnerHTML: { __html: "<use xlink:href='assets/symbols.svg#alt-logo'/>" } });

	  return _react2.default.createElement(
	    'div',
	    { className: 'items__item half' },
	    _react2.default.createElement(
	      'a',
	      { href: props.link, className: 'item-image', style: props.image ? { backgroundImage: 'url(' + props.image + ')' } : { backgroundImage: 'none' } },
	      !props.image ? altLogo : ''
	    ),
	    _react2.default.createElement(
	      'div',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          props.tags.map(function (tag) {
	            return _react2.default.createElement(
	              'button',
	              { onClick: props.onClickTag, key: tag },
	              tag
	            );
	          }, undefined)
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: 'https://twitter.com/intent/tweet?url=' + props.link + '&text=Another great link from https://sassisfaction.com :: &related=yarrcat' },
